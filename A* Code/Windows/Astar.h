...
class point {
public:
    point(int a = 1, int b = 1) { x = a; y = b; }   //  starting point
    //point(int a = static_cast<int>(floor(ghost[3][0] / squareSize)), int b = static_cast<int>(floor(ghost[3][1] / squareSize))) { x = a; y = b; }
    bool operator ==(const point& o) { return o.x == x && o.y == y; }
    point operator +(const point& o) { return point(o.x + x, o.y + y); }
    int x, y;
};

//  x coord pacman:    static_cast<int>(floor(pacmanX / squareSize))
...
public:
    map() {
        ...
        //  pacman map
        {
            ...
            {'I','I','I','I','I','V','b','V','V','b','1','H','H','S','S','H','H','3','b','V','V','b','V','I','I','I','I','I'},  //	13          
            ...
            {'V','k','a','g','V','V','e','a','a','c','a','a','d','a','a','d','a','a','c','a','a','f','V','V','h','a','i','V'},  //	24         
...
public:
    ...
    bool fillOpen(node& n) {
        ...
        for (int x = 0; x < 4; x++) {
            ...
            if (isValid(neighbour) && m(neighbour.x, neighbour.y) != 'H' && m(neighbour.x, neighbour.y) != 'V'
                && m(neighbour.x, neighbour.y) != '1' && m(neighbour.x, neighbour.y) != '2'
                && m(neighbour.x, neighbour.y) != '3' && m(neighbour.x, neighbour.y) != '4')
            {
                nc = stepCost + n.cost;
