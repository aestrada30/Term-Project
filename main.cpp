...
const MoveDir ghostStartDir[] = { LEFT_DIR , LEFT_DIR, RIGHT_DIR, RIGHT_DIR };
...

{
    ...
    //ghost coordinates test output
...

        {
                ...
                displayTextualInfo("GET ABSOLUTELY FUCKED", gridWidth / 2 - 3 * squareSize, winHeight / 2 - 1.5f * squareSize, LARGE_FONT, true);
